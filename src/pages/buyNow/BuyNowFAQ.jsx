        ...
        {isOpen && (
          ...
          >
            <p className="pb-5 text-gray-600 text-base leading-relaxed pr-8">
              {answer || "This is a placeholder answer. Add your specific response here."}
            </p>
          </motion.div>
        )}
      </AnimatePresence>
...
const BuyNowFAQ = () => {
  const leftColumnFAQs = [
    { question: "What makes Brampton IPTV different ?" },
    { question: "How many Channels do you offer ?" },
    { question: "Do you Offer IPTV Set Top Boxes ?" }
  ];

  const rightColumnFAQs = [
    { question: "Is streaming in 4K really possible ?" },
    { question: "What if I need help ?" },
    { question: "How do I get started ?" }
  ];

  return (
    // Light gray background specifically for this FAQ section
